            ...
            <div className="mx-auto max-w-3xl overflow-hidden rounded-3xl bg-[#0B1120] px-8 py-16 text-center sm:px-16 relative">
              ...
              <div className="relative">
                ...
                <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
                  <Link
                    href="/contact-us"
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl bg-blue-600 px-8 py-4 text-[15px] font-bold text-white shadow-xl shadow-blue-600/25 transition-all hover:bg-blue-700 hover:-translate-y-px"
                  >
                    Book a Free Consultation
                    <ArrowRightIcon className="w-4 h-4" />
                  </Link>
